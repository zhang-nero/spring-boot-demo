...
import com.nero.spring.boot.demo.mapper.db1.Table1Mapper;
...
public class Table1Service {
    ...
    public int addTable1(String name){
        ...
        table1.setName1(name);
        int i = table1Mapper.addTable1(table1);
    ...
    public List<Table1> queryTable1(String queryString, Integer pageNumber, Integer pageSize){
        ...
        return table1Mapper.selectTable1(queryString);
    }
}
